...
namespace Jobba.Core.Extensions
{
    ...
    {
        public static IServiceCollection RegisterReplace<TService, TImpl>(this IServiceCollection serviceCollection, ServiceLifetime lifetime = ServiceLifetime.Scoped)
