...
public class DefaultOnJobWatchSubscriber<TJob, TJobParams, TJobState> : AbstractJobbaEventSubscriber, IOnJobWatchSubscriber<TJob, TJobParams, TJobState>
    ...
    where TJobState : IJobState
{
    ...
    public DefaultOnJobWatchSubscriber(
        ILogger<DefaultOnJobWatchSubscriber<TJob, TJobParams, TJobState>> logger,
    ...
    {
        if (!ShouldProcessEvent(jobWatchEvent))
        {
            return;
        }
